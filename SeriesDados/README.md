...
[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-718a45dd9cf7e7f842a935f5ebbe5719a5e09af4491e668f4dbf3b35d5cca122.svg)](https://classroom.github.com/online_ide?assignment_repo_id=11369329&assignment_repo_type=AssignmentRepo)
# Séries de Dados
...
| Estoque produtos mercado | quantidade de arroz e feijão (pacotes) | semanal         |        1       |            4 |
...
> ... Pois recebe uma lista das séries por parâmetro, lista esta que é uma interface.   Que permite com que, os métodos públicos sejam acessados, sem conhecer de forma específica sua real implementação. Servindo apenas como um contrato do que a implementação deve ter, mas sem saber como será realizada.  ...

3. O que o polimorfismo tem a ver com o que foi feito?

> ... Ele permite com que diversas implementações de série de dados sejam criadas, sem precisar que a classe VisualizadorSeries saiba exatamente as suas aplicações. O polimorfismo se faz necessário, já que avalia de forma genérica os métodos aplicados na interface, e pode ser aplicado para todos os tipos de dados que seguirem o mesmo padrão. ...

4. Para que então servem as interfaces (como tipo de dado)?

> ... Para servir como um contrato do que cada série de dados precisa ter para que o polimorfismo seja aplicado de forma correta e coesa. As interfaces conseguem manter uma comunicação entre diversos componentes do sistema, de tal forma que é possível implementar novas funcionalidades sem afetar a classe VisualizadorSeries. ...
